...
#
# sysGen.tcl: Tcl script for re-creating project 'dmaSystem'
#
# Generated by Vivado on Mon May 04 19:14:16 +0600 2020
...
#
#    "D:/VivadoProject/dmaSystem/dmaSystem.srcs/sources_1/bd/dmaSystem/hdl/dmaSystem_wrapper.v"
#
...
set files [list \
 "[file normalize "../hdl/dmaSystem_wrapper.v"]"\
]
...
set file "hdl/dmaSystem_wrapper.v"
...
set_property -name "top" -value "dmaSystem_wrapper" -objects $obj
...
# Proc to create BD dmaSystem
proc cr_bd_dmaSystem { parentCell } {
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXI_MM2S] [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins system_ila_0/SLOT_3_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets inverter_0_m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_5_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
# End of cr_bd_dmaSystem()
cr_bd_dmaSystem ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files dmaSystem.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files dmaSystem.bd ] 
set_property IS_ENABLED "1" [get_files dmaSystem.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files dmaSystem.bd ] 
set_property IS_LOCKED "0" [get_files dmaSystem.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files dmaSystem.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files dmaSystem.bd ] 
set_property PFM_NAME "" [get_files dmaSystem.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files dmaSystem.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files dmaSystem.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files dmaSystem.bd ] 
set_property USED_IN_SIMULATION "1" [get_files dmaSystem.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files dmaSystem.bd ] 
